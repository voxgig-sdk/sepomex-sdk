...
class SepomexTimeoutFeature extends SepomexBaseFeature
{
    ...
    private function _with_timeout(SepomexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SepomexContext $_ctx, float $ms): void
    {
        $client = $this->client;
