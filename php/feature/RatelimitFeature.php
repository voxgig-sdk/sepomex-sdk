...
class SepomexRatelimitFeature extends SepomexBaseFeature
{
    ...
    private function _acquire(SepomexContext $ctx): void
    {
    ...
    private function _track(SepomexContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
