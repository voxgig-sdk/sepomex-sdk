...
class SepomexNetsimFeature extends SepomexBaseFeature
{
    ...
    private function _simulate(SepomexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SepomexContext $ctx, array $applied): void
    {
        $client = $this->client;
