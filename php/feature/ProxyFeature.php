...
class SepomexProxyFeature extends SepomexBaseFeature
{
    ...
    public function init(SepomexContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SepomexContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
