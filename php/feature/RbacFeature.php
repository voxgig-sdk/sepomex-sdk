...
class SepomexRbacFeature extends SepomexBaseFeature
{
    ...
    private function _required(SepomexContext $ctx): ?string
    {
    ...
    private function _reject(SepomexContext $ctx, string $required): void
    {
    ...
    private function _track(SepomexContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
