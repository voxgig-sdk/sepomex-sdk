...
class SepomexStreamingFeature extends SepomexBaseFeature
{
    ...
    private function _iterate(SepomexResult $result): \Generator
    {
    ...
    private function _streamable(SepomexContext $ctx): bool
    {
