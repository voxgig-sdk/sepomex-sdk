...
class SepomexGraphql
{
    ...
    // equivalent.
    public static function body(SepomexContext $ctx): mixed
    {
    ...
    public static function errors(SepomexContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
