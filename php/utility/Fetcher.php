...
// Sepomex SDK utility: fetcher

class SepomexFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SepomexSDK/1.0)';
    ...
    public static function call(SepomexContext $ctx, string $fullurl, array $fetchdef): array
    {
