...
// Sepomex SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SepomexSDK::test)
...
{
    private const SDK_CLASS = 'SepomexSDK';
    ...
    private const SDK_BASE = 'sepomex_sdk';
