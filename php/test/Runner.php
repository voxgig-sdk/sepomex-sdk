...
class SepomexTestRunner
{
    ...
    {
        $live = self::getenv('SEPOMEX_TEST_LIVE');
        $override = self::getenv('SEPOMEX_TEST_OVERRIDE');
        ...
        $explain = self::getenv('SEPOMEX_TEST_EXPLAIN');
...
class_alias('SepomexTestRunner', 'Runner');
class_alias('SepomexHelpers', 'Helpers');
