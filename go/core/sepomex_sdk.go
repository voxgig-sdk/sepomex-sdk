...
func (sdk *SepomexSDK) OptionsMap() map[string]any {
...
func (sdk *SepomexSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *SepomexSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *SepomexSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SepomexSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *SepomexSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *SepomexSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("SepomexSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *SepomexSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SepomexSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("SepomexSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
