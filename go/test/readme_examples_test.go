...
const testSeed = `map[string]any{"entity": map[string]any{"city": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "municipality": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "state": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "zip_code": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
