...
func NewZipCodeEntity(client *core.SepomexSDK, entopts map[string]any) *ZipCodeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ZipCodeEntity) GetName() string { return e.name }
...
func (e *ZipCodeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ZipCodeEntity) Deleted() bool {
	return e.deleted
}


func (e *ZipCodeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewZipCodeEntity(e.client, opts)
}

func (e *ZipCodeEntity) Data(args ...any) any {
...
func (e *ZipCodeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ZipCode; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ZipCodeEntity) DataTyped(data ...ZipCode) ZipCode {
	if len(data) > 0 {
		return typedFrom[ZipCode](e.Data(asMap(data[0])))
	}
	return typedFrom[ZipCode](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ZipCode (all fields
// optional at the wire level).
func (e *ZipCodeEntity) MatchTyped(match ...ZipCode) ZipCode {
	if len(match) > 0 {
		return typedFrom[ZipCode](e.Match(asMap(match[0])))
	}
	return typedFrom[ZipCode](e.Match())
}
...
func (e *ZipCodeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ZipCodeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ZipCodeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ZipCodeListMatch and returns []ZipCode. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ZipCodeEntity) ListTyped(reqmatch ZipCodeListMatch, ctrl map[string]any) ([]ZipCode, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ZipCode](res), nil
}



func (e *ZipCodeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ZipCodeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ZipCodeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ZipCodeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
