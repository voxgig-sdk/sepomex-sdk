...
func NewCityEntity(client *core.SepomexSDK, entopts map[string]any) *CityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CityEntity) GetName() string { return e.name }
...
func (e *CityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CityEntity) Deleted() bool {
	return e.deleted
}


func (e *CityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCityEntity(e.client, opts)
}

func (e *CityEntity) Data(args ...any) any {
...
func (e *CityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *CityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CityEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *CityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
