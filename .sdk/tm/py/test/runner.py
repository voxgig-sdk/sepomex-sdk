...
class SepomexTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SepomexTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SepomexTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SepomexTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
