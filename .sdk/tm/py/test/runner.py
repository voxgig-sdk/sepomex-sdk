...
class SepomexTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SepomexTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = SepomexTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = SepomexTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
