...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = SepomexOmni.make_runner(TEST_JSON_FILE, SepomexSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : SepomexOmni.errify(err)
    end
