...
class SepomexCacheFeature extends SepomexBaseFeature
{
    ...
    private function _through(SepomexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
