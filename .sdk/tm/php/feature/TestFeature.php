...
// Sepomex SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class SepomexTestFeature extends SepomexBaseFeature
{
    ...
    public function init(SepomexContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (SepomexContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (SepomexContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(SepomexContext $ctx, $op, $args): array
    {
