...
// Sepomex SDK clienttrack feature
...
class SepomexClienttrackFeature extends SepomexBaseFeature
{
    ...
    public function PostConstruct(SepomexContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Sepomex-SDK';
