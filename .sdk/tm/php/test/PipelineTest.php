...
{
    private static function utility(): SepomexUtility
    {
        return new SepomexUtility();
    }
    ...
    private static function ctx(array $over = []): SepomexContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new SepomexContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new SepomexOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof SepomexError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new SepomexOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = SepomexMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new SepomexOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = SepomexMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new SepomexOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = SepomexMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SepomexSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = SepomexMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new SepomexResponse([]),
            'result' => new SepomexResult([]),
        ]);
        [, $err] = SepomexMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new SepomexSpec([]),
            'response' => null,
            'result' => new SepomexResult([]),
        ]);
        [, $err] = SepomexMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new SepomexSpec(['step' => 's']),
            'response' => new SepomexResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new SepomexResult([]),
        ]);
        [, $err] = SepomexMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new SepomexSpec(['step' => 's']),
            'response' => new SepomexResponse(self::resp(200, ['v' => 1])),
            'result' => new SepomexResult([]),
        ]);
        [, $err] = SepomexMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new SepomexSpec(['step' => 's']),
            'response' => new SepomexResponse(self::resp(200, ['v' => 2])),
            'result' => new SepomexResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        SepomexMakeResponse::call($ctx);
    ...
    {
        $preset = new SepomexResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new SepomexSpec([]),
            'response' => new SepomexResponse([]),
            'result' => new SepomexResult([]),
        ...
        [$got, $err] = SepomexMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new SepomexResult([])]);
        [, $err] = SepomexMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new SepomexSpec([]), 'result' => null]);
        [, $err] = SepomexMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SepomexSpec(['step' => 's']),
            'result' => new SepomexResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new SepomexOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SepomexMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SepomexSpec(['step' => 's']),
            'result' => new SepomexResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new SepomexOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SepomexMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SepomexResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new SepomexSpec([]),
            'result' => new SepomexResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = SepomexMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SepomexMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new SepomexError('boom', 'boom');
        $utility->fetcher = function (SepomexContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SepomexSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = SepomexMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (SepomexContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = SepomexMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(SepomexResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (SepomexContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SepomexSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = SepomexMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new SepomexResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new SepomexSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = SepomexMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = SepomexMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = SepomexMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new SepomexResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, SepomexDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new SepomexResult(['ok' => false])]);
        $this->expectException(SepomexError::class);
        SepomexDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new SepomexResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', SepomexMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        SepomexMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new SepomexBaseFeature();
        $b = new SepomexBaseFeature();
        SepomexFeatureAdd::call($ctx, $a);
        SepomexFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): SepomexBaseFeature
    {
        $f = new SepomexBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        SepomexFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): SepomexContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new SepomexSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SepomexPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new SepomexResponse(['headers' => null]),
            'result' => new SepomexResult([]),
        ]);
        SepomexResultHeaders::call($ctx);
