...
// Sepomex SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SepomexOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SepomexOmni::structfix($now, Struct::undef()))
                        !== json_encode(SepomexOmni::structfix($val, Struct::undef()))) {
