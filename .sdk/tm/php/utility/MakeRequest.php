...
// Sepomex SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class SepomexMakeRequest
{
    public static function call(SepomexContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new SepomexResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new SepomexResponse($fetched);
        } else {
