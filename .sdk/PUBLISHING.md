...
|---|---|---|
| `ts/` | @voxgig-sdk/sepomex-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/sepomex-sdk \
      --repository voxgig-sdk/sepomex-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/sepomex-sdk` shows it, and
`npm trust revoke @voxgig-sdk/sepomex-sdk --id=<id>` removes it.
