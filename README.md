...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/sepomex` | `npm install @voxgig-sdk/sepomex` |
| Python | `voxgig-sdk-sepomex` | `pip install voxgig-sdk-sepomex` |
| PHP | `voxgig-sdk/sepomex` | `composer require voxgig-sdk/sepomex` |
| Golang | `github.com/voxgig-sdk/sepomex-sdk/go` | `go get github.com/voxgig-sdk/sepomex-sdk/go` |
| Ruby | `voxgig-sdk-sepomex` | `gem install voxgig-sdk-sepomex` |
| Lua | `voxgig-sdk-sepomex` | `luarocks install voxgig-sdk-sepomex` |
