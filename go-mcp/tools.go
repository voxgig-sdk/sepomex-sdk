...
type Args struct {
	Entity string         `json:"entity" jsonschema:"city | municipality | state | zip_code"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.SepomexSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "sepomex_list",
		Description: "List records from Sepomex. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "sepomex_load",
		Description: "Load a single record from Sepomex. " +
...
func runOp(client *sdk.SepomexSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SepomexSDK, name string) (sdk.SepomexEntity, error) {
	switch strings.ToLower(name) {
	case "city":
		return client.City(nil), nil
	case "municipality":
		return client.Municipality(nil), nil
	case "state":
		return client.State(nil), nil
	case "zip_code":
		return client.ZipCode(nil), nil
