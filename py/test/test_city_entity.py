...
class TestCityEntity:
    ...
    def test_should_stream(self):
        ...
        seen = list(base.City(None).stream("list", None, None))
        assert len(seen) == 3
        ...
        if isinstance(cfg.get("feature"), dict) and "streaming" in cfg["feature"]:
            ...
            got = []
            for item in sdk.City(None).stream("list", None, None):
    ...
    def test_should_run_basic_flow(self):
        ...
        city_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(city_ref01_data_dt0_loaded))
