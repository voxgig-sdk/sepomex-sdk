# Sepomex SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SepomexSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SepomexSDK(...) and SepomexSDK.test(...) become
#      SepomexSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "sepomex_sdk"
_SDK_CLASS = "SepomexSDK"
