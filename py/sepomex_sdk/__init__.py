...
from sepomex_sdk.utility import register

# Load features
from sepomex_sdk.feature.base_feature import SepomexBaseFeature
from sepomex_sdk.features import _has_feature, _make_feature
...
class SepomexSDK:
    ...
    def get_utility(self):
        return SepomexUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SepomexSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def City(self, data=None) -> "CityEntity":
        ...
        from sepomex_sdk.entity.city_entity import CityEntity
    ...
    def Municipality(self, data=None) -> "MunicipalityEntity":
        ...
        from sepomex_sdk.entity.municipality_entity import MunicipalityEntity
    ...
    def State(self, data=None) -> "StateEntity":
        ...
        from sepomex_sdk.entity.state_entity import StateEntity
    ...
    def ZipCode(self, data=None) -> "ZipCodeEntity":
        ...
        from sepomex_sdk.entity.zip_code_entity import ZipCodeEntity
