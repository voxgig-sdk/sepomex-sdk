...
from sepomex_sdk.core.helpers import get_ctx_prop, to_map
...
class SepomexContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, SepomexResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return SepomexError(code, msg, self)
