...
describe("ZipCodeDirect", function()
  it("should direct-list-zip_code", function()
    local setup = zip_code_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-zip_code", setup.live and "live" or "unit")
...
function zip_code_direct_setup(mockres)
