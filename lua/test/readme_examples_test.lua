...
-- data to return.
local TEST_SEED = '{ entity = { ["city"] = { ["test01"] = { id = "test01" } }, ["municipality"] = { ["test01"] = { id = "test01" } }, ["state"] = { ["test01"] = { id = "test01" } }, ["zip_code"] = { ["test01"] = { id = "test01" } } } }'
