...
func registerSDKWords(r *eng.Registry, client *sdk.SepomexSDK) {
...
func runOp(client *sdk.SepomexSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
