...
function envOverride(m) {
    if ('TRUE' === process.env.SEPOMEX_TEST_LIVE ||
        'TRUE' === process.env.SEPOMEX_TEST_OVERRIDE) {
    ...
    m.SEPOMEX_TEST_EXPLAIN = process.env.SEPOMEX_TEST_EXPLAIN || m.SEPOMEX_TEST_EXPLAIN;
    return m;
}
