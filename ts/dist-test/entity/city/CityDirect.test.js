...
(0, node_test_1.describe)('CityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-city', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-city', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-city', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-city', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SEPOMEX_TEST_CITY_ENTID'];
...
//# sourceMappingURL=CityDirect.test.js.map