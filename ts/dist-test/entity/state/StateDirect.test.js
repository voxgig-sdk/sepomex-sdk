...
(0, node_test_1.describe)('StateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-state', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-state', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SEPOMEX_TEST_STATE_ENTID'];
