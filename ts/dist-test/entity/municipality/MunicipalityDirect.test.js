...
(0, node_test_1.describe)('MunicipalityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-municipality', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-municipality', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-municipality', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-municipality', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SepomexSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['SEPOMEX_TEST_MUNICIPALITY_ENTID'];
    ...
    const client = new __1.SepomexSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=MunicipalityDirect.test.js.map