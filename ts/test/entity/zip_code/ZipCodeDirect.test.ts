...
describe('ZipCodeDirect', async () => {
  ...
  test('direct-list-zip_code', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-zip_code', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['SEPOMEX_TEST_ZIP_CODE_ENTID']
