...
module SepomexTestRunner
  ...
  def self.env_override(m)
    live = getenv("SEPOMEX_TEST_LIVE")
    override = getenv("SEPOMEX_TEST_OVERRIDE")
    ...
    explain = getenv("SEPOMEX_TEST_EXPLAIN")
    m["SEPOMEX_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = SepomexTestRunner
Helpers = SepomexHelpers
Vs = VoxgigStruct
