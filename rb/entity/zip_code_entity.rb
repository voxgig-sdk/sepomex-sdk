...
class ZipCodeEntity
  ...
  def make
    opts = @_entopts.dup
    ZipCodeEntity.new(@_client, opts)
  end
  ...
  # @return [ZipCode, Hash] the current ZipCode data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ZipCode fields)
  def match_get
  ...
  #
  # @param reqmatch [ZipCodeListMatch, Hash, nil] match filter (any subset of
  #   ZipCode fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ZipCode>, Array] the matching ZipCode items; raises SepomexError on failure
